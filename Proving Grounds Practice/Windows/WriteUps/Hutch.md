...
It appears that the server has _WebDAV_ enabled. WebDAV is an extension of the Hypertext Transfer Protocol that allows clients to perform remote web content authoring operations.
